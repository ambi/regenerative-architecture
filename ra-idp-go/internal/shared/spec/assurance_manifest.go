...
var AssuranceManifest = map[string][]AssuranceVerification{
	...
	"AuthorizationCodeStoreContract": {
		{File: "ra-idp-go/internal/shared/adapters/persistence/memory/memory_test.go", Check: "TestAuthorizationCodeRedeemIsAtomic"},
		{File: "ra-idp-go/internal/shared/adapters/persistence/valkey/valkey_test.go", Check: "TestAuthorizationCodeRedeemOnce"},
	},
	...
	"ResetTokenStorageTests": {
		{File: "ra-idp-go/internal/shared/adapters/persistence/memory/password_reset_token_store_test.go", Check: "TestPasswordResetTokenStoreConsumeSucceedsOnceConcurrently"},
	...
	"SpecificationBindingTests": {
		{File: "ra-idp-go/internal/shared/spec/coherence_test.go", Check: "TestCurrentSCLLoadsAllNormativeSections"},
		{File: "ra-idp-go/internal/shared/spec/admin_policy_test.go", Check: "TestSCLPermissionsHaveGoActionMappings"},
	},
	"CoherenceCheck": {
		{File: "ra-idp-go/internal/shared/spec/coherence_test.go", Check: "TestCurrentSCLIsInternallyCoherent"},
