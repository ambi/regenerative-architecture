...
import { InMemoryAuthorizationRequestStore } from '../../adapters/persistence/in-memory-authorization-store'
import { InMemoryClientRepository } from '../../adapters/persistence/in-memory-client-repo'
import { InMemoryConsentRepository } from '../../adapters/persistence/in-memory-consent-repo'
