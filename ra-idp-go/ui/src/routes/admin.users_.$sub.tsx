...
import type { AdminUserDetailPage as AdminUserDetailPageData, TenantUserAttributeSchema } from '../types'
import { requirePortalAccount } from './-guards'
import { PageMarker } from './-page'

export const Route = createFileRoute('/admin/users_/$sub')({
  loader: async ({ location, params }): Promise<AdminUserDetailPageData> => {
