...
func registerTenantRoutes(g *echo.Group, d Deps) {
	...
	g.GET("/api/admin/authentication_events", d.handleListAuthenticationEvents)
	g.GET("/api/admin/authentication_events/export", d.handleExportAuthenticationEvents)
	g.GET("/api/admin/authentication_events/:id", d.handleGetAuthenticationEvent)
